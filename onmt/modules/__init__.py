...
from onmt.modules.Embeddings import Embeddings, PositionalEncoding, UsePretrainModel
...
#           RNNEncoder, NMTModel,StdRNNDecoder, 
__all__ = [EncoderBase, MeanEncoder, RNNDecoderBase, InputFeedRNNDecoder,
            RNNEncoder, NMTModel, StdRNNDecoder, 
           ContextGate, GlobalAttention, GlobalSelfAttention, ImageEncoder,
           PositionwiseFeedForward, PositionalEncoding,
           CopyGenerator, MultiHeadedAttention,
           LayerNorm,
           TransformerEncoder, TransformerDecoder, Embeddings, UsePretrainModel, Elementwise,
